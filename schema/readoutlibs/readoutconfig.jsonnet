...
local readoutconfig = {
    ...
    rawdataprocessorconf : s.record("RawDataProcessorConf", [
            ...
            s.field("tpg_threshold_default", self.count, 120,
                            doc="Select the default TPG threshold."),
            s.field("tpg_threshold_plane0", self.count, 0,
                            doc="Select the TPG threshold for plane 0. Defaults to tpg_threshold_default if empty."),
            s.field("tpg_threshold_plane1", self.count, 0,
                            doc="Select the TPG threshold for plane 1. Defaults to tpg_threshold_default if empty."),
            s.field("tpg_threshold_plane2", self.count, 0,
                            doc="Select the TPG threshold for plane 2. Defaults to tpg_threshold_default if empty."),
            s.field("tpg_rs_memory_factor_default", self.pct, 0.8,
                            doc="Default memory factor (R) for the TPG running sum algorithms."),
            s.field("tpg_rs_memory_factor_plane0", self.pct, -1,
                            doc="Plane 0 memory factor (R) for the TPG running sum algorithms. Defaults to tpg_rs_memory_factor_default if empty."),
            s.field("tpg_rs_memory_factor_plane1", self.pct, -1,
                            doc="Plane 1 memory factor (R) for the TPG running sum algorithms. Defaults to tpg_rs_memory_factor_default if empty."),
            s.field("tpg_rs_memory_factor_plane2", self.pct, -1,
                            doc="Plane 2 memory factor (R) for the TPG running sum algorithms. Defaults to tpg_rs_memory_factor_default if empty."),
            s.field("tpg_rs_scale_factor_default", self.count, 2,
                            doc="Default scale factor for the TPG running sum algorithms."),
            s.field("tpg_rs_scale_factor_plane0", self.count, 0,
                            doc="Plane 0 scale factor for the TPG running sum algorithms. Defaults to tpg_rs_scale_factor_default if empty."),
            s.field("tpg_rs_scale_factor_plane1", self.count, 0,
                            doc="Plane 1 scale factor for the TPG running sum algorithms. Defaults to tpg_rs_scale_factor_default if empty."),
            s.field("tpg_rs_scale_factor_plane2", self.count, 0,
                            doc="Plane 2 scale factor for the TPG running sum algorithms. Defaults to tpg_rs_scale_factor_default if empty."),

...
local readoutconfig = {
    ...
    rawdataprocessorconf : s.record("RawDataProcessorConf", [
            ...
            s.field("enable_simple_threshold_on_plane2", self.choice, false,
                            doc="Enable SimpleThreshold TPG algorithm only on plane 2 when a Running Sum algorithm is enabled"),

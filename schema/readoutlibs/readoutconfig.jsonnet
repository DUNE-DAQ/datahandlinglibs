...
local readoutconfig = {
    ...
    rawdataprocessorconf : s.record("RawDataProcessorConf", [
            ...
            s.field("collection_threshold", self.count, 0,
                            doc="Select TPG threshold for collection plane. Uses tpg_threshold if 0."),
            s.field("induction1_threshold", self.count, 0,
                            doc="Select TPG threshold for induction 1 plane. Uses tpg_threshold if 0."),
            s.field("induction2_threshold", self.count, 0,
                            doc="Select TPG threshold for induction 2 plane. Uses tpg_threshold if 0."),

...
main(int /*argc*/, char** /*argv[]*/)
{
    ...
    unittest::MockReadoutType,
    unittest::MockRequestHandlerType<unittest::MockReadoutType,unittest::MockLatencyBufferType <unittest::MockReadoutType>>,
    unittest::MockLatencyBufferType<unittest::MockReadoutType>,
    unittest::MockRawDataProcessorType,
    unittest::MockReadoutType>>(run_marker);
    ...
    DefaultRequestHandlerModel<unittest::MockReadoutType, unittest::MockLatencyBufferType<unittest::MockReadoutType>> default_request_handler_model(latency_buffer, error_registry);

    auto latency_buffer2 = std::make_shared<SkipListLatencyBufferModel<unittest::MockReadoutType>>();
    auto error_registry2 = std::make_unique<dunedaq::datahandlinglibs::FrameErrorRegistry>();
    DefaultSkipListRequestHandler <unittest::MockReadoutType> default_skiplist_request_handler(latency_buffer2,error_registry2);
    
    EmptyFragmentRequestHandlerModel <unittest::MockReadoutType,unittest::MockLatencyBufferType<unittest::MockReadoutType>>empty_fragment_request_handler_model(latency_buffer,error_registry);
    ...
    TaskRawDataProcessorModel <unittest::MockReadoutType> task_rawdata_processor_model(error_registry,false);
    ZeroCopyRecordingRequestHandlerModel <unittest::MockReadoutType,unittest::MockLatencyBufferType<unittest::MockReadoutType>> zero_copy_recording_request_hander_model(latency_buffer,error_registry);
